...
return [
    ...
    */
    ...
    | convention "attribute.rule" pour nommer les lignes. Cela nous permet de spécifier rapidement un message personnalisé spécifique pour une règle d\'attribut donnée.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes de langage suivantes sont utilisées pour remplacer notre espace réservé d\'attribut par quelque chose de plus convivial pour le lecteur tel que "Adresse e-mail" au lieu
